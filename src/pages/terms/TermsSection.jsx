      ...
      <div className="relative z-10 flex flex-col lg:flex-row gap-10 ">
        <div className="flex flex-col md:flex-row   lg:flex-col gap-4 md:gap-20 lg:gap-4 w-full">
          <div className="" >
            ...
            <p data-aos="fade-up" className=" text-3xl md:text-5xl font-semibold">Terms</p>
            ...
            <p data-aos="slide-right" data-aos-easing='ease-out'    data-aos-duration='1500'  className=" text-xl md:text-[38px] font-semibold">Must Apply</p>
            </div>
          </div>
